...
public class ServletJConnection extends HttpServlet{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException{
		...
		try{
			...
			rd=req.getRequestDispatcher("/errorurl");  //here "/" forward slash is not compulsory
			rd.forward(req,res);
			//if you place multiple rd.forward() in one source that time illegalStateException will raise
			//rd=req.getRequestDispatcher("/rew");  //here "/" forward slash is not compulsory
			//rd.forward(req,res);
			//rd.include(req,res);
		}
		finally{
